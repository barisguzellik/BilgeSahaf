...
{
    public partial class RAPOR_GELEN_HAVALE: Form
    {
        public RAPOR_GELEN_HAVALE()
        {
            InitializeComponent();
        }
        ...
        private void RAPOR_STOK_KARTLARI_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT*FROM BANKALAR_V2 INNER JOIN GELEN_HAVALE_V2 ON BANKALAR_V2.ID=GELEN_HAVALE_V2.BANKA ORDER BY GELEN_HAVALE_V2.ID DESC");
