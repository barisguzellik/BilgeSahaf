...
{
    public partial class RAPOR_CIKISLAR : Form
    {
        public RAPOR_CIKISLAR()
        {
            InitializeComponent();
        }
        ...
        private void RAPOR_STOK_KARTLARI_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT*FROM BANKALAR_V2 INNER JOIN BANKA_CIKISLAR_V2 ON BANKALAR_V2.ID=BANKA_CIKISLAR_V2.BANKA ORDER BY BANKA_CIKISLAR_V2.ID DESC");
