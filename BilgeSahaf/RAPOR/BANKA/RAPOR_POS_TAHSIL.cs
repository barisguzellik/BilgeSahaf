...
{
    public partial class RAPOR_POS_TAHSIL : Form
    {
        public RAPOR_POS_TAHSIL()
        {
            InitializeComponent();
        }
        ...
        private void RAPOR_STOK_KARTLARI_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT*FROM BANKALAR_V2 INNER JOIN POS_TAHSIL_V2 ON BANKALAR_V2.ID=POS_TAHSIL_V2.BANKA ORDER BY POS_TAHSIL_V2.ID DESC");
