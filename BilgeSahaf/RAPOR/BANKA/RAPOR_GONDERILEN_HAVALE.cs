...
{
    public partial class RAPOR_GONDERILEN_HAVALE: Form
    {
        public RAPOR_GONDERILEN_HAVALE()
        {
            InitializeComponent();
        }
        ...
        private void RAPOR_STOK_KARTLARI_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT*FROM BANKALAR_V2 INNER JOIN GONDERILEN_HAVALE_V2 ON BANKALAR_V2.ID=GONDERILEN_HAVALE_V2.BANKA ORDER BY GONDERILEN_HAVALE_V2.ID DESC");
