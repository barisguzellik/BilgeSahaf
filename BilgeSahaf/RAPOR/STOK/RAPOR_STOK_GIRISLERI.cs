...
{
    public partial class RAPOR_STOK_GIRISLERI : Form
    {
        public RAPOR_STOK_GIRISLERI()
        {
            InitializeComponent();
        }
        ...
        private void RAPOR_STOK_KARTLARI_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT*FROM STOK_GIRISLERI_V2");
        ...
        private void sORGUÇALIŞTIRToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            frm.QUERY = "SELECT*FROM STOK_GIRISLERI_V2;";
            frm.ShowDialog();
