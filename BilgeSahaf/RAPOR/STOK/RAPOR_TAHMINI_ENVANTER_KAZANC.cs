...
{
    public partial class RAPOR_TAHMINI_ENVANTER_KAZANC : Form
    {
        public RAPOR_TAHMINI_ENVANTER_KAZANC()
        {
            InitializeComponent();
        }
        ...
        public void processCommand()
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                dr["KAZANC"] = double.Parse(dr["FIYAT_1"].ToString()) * int.Parse(dr["KALAN"].ToString());
