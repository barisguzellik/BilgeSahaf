...
{
    public partial class RAPOR_SATIS_FATURALARI : Form
    {
        public RAPOR_SATIS_FATURALARI()
        {
            InitializeComponent();
        }
        ...
        private void RAPOR_STOK_KARTLARI_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT*FROM SATIS_FATURALARI_V2");
