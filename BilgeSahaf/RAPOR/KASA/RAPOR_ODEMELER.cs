...
{
    public partial class RAPOR_ODEMELER : Form
    {
        public RAPOR_ODEMELER()
        {
            InitializeComponent();
        }
        ...
        private void RAPOR_STOK_KARTLARI_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT *FROM ODEMELER_V2 ORDER BY ODEMELER_V2.ID DESC");
