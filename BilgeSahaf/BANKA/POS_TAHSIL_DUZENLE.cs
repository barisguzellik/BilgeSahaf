...
{
    public partial class POS_TAHSIL_DUZENLE : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public POS_TAHSIL_DUZENLE()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                helper.setSqlCommandForUpdateWithParameters("POS_TAHSIL_V2", col, val, "ID", ITEM_ID.ToString());
        ...
        private void TAHSILAT_EKLE_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = helper.getDataTable("SELECT TOP 1 *FROM POS_TAHSIL_V2 WHERE ID=" + ITEM_ID + "");
            if (dt.Rows.Count > 0)
            {
        ...
        private void tAHSİLATISİLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                helper.setSqlCommand("DELETE FROM POS_TAHSIL_V2 WHERE ID=" + ITEM_ID + "");
                this.Close();
