...
{
    public partial class GIRIS_DUZENLE : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public GIRIS_DUZENLE()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                helper.setSqlCommandForUpdateWithParameters("BANKA_GIRISLER_V2", col, val,"ID",ITEM_ID.ToString());
        ...
        private void YENI_KASA_EKLE_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = helper.getDataTable("SELECT*FROM BANKA_GIRISLER_V2 WHERE ID="+ITEM_ID+"");
            if (dt.Rows.Count > 0)
            {
        ...
        {
            helper.setSqlCommand("DELETE FROM BANKA_GIRISLER_V2 WHERE ID=" + ITEM_ID + "");
            this.Close();
        }
    }
}
