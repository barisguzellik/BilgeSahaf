...
{
    public partial class GELEN_HAVALE_DUZENLE : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public GELEN_HAVALE_DUZENLE()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                helper.setSqlCommandForUpdateWithParameters("GELEN_HAVALE_V2", col, val, "ID", ITEM_ID.ToString());
        ...
        private void TAHSILAT_EKLE_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = helper.getDataTable("SELECT TOP 1 *FROM GELEN_HAVALE_V2 WHERE ID=" + ITEM_ID + "");
            if (dt.Rows.Count > 0)
            {
        ...
        private void tAHSİLATISİLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                helper.setSqlCommand("DELETE FROM GELEN_HAVALE_V2 WHERE ID=" + ITEM_ID + "");
                this.Close();
