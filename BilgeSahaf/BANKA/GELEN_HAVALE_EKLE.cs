...
{
    public partial class GELEN_HAVALE_EKLE : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public GELEN_HAVALE_EKLE()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            string[] col =
           {
            ...
            try
            {
                helper.setSqlCommandForInsertWithParameters("GELEN_HAVALE_V2", col, val);
