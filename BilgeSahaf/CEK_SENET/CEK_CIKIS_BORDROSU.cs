...
{
    public partial class CEK_CIKIS_BORDROSU : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public CEK_CIKIS_BORDROSU()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                helper.setSqlCommandForInsertWithParameters("CEK_CIKIS_BORDROSU_V2", col, val);
                string lastID = helper.getTableColumnData("SELECT TOP 1 ID FROM CEK_CIKIS_BORDROSU_V2 ORDER BY ID DESC", "ID");
