...
{
    public partial class SENET_CIKIS_BORDROSU : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public SENET_CIKIS_BORDROSU()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                helper.setSqlCommandForInsertWithParameters("SENET_CIKIS_BORDROSU_V2", col, val);
                string lastID = helper.getTableColumnData("SELECT TOP 1 ID FROM SENET_CIKIS_BORDROSU_V2 ORDER BY ID DESC", "ID");
