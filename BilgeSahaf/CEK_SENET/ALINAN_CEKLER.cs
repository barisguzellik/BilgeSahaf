...
{
    public partial class ALINAN_CEKLER : Form
    {
        public ALINAN_CEKLER()
        {
            InitializeComponent();
        }
        ...
        {
            CEK_SENET.CEK_GIRIS_BORDROSU frm = new CEK_GIRIS_BORDROSU();
            frm.ShowDialog();
            getDefault();
        }
        ...
        {
            dataGridView1.Tag = "AlCekGrid1";
            dataGridView2.Tag = "AlCekGrid2";
        ...
        string COLS = "CEK_GIRIS_BORDROSU_V2.ID,CARI_KARTLAR_V2.UNVANI,CEK_GIRIS_BORDROSU_V2.TARIH,CEK_GIRIS_BORDROSU_V2.BELGE_TARIHI,CEK_GIRIS_BORDROSU_V2.BELGE_NUMARASI,CEK_GIRIS_BORDROSU_V2.EVRAK_NUMARASI,CEK_GIRIS_BORDROSU_V2.ARA_TOPLAM,CEK_GIRIS_BORDROSU_V2.MASRAF,CEK_GIRIS_BORDROSU_V2.TOPLAM,CEK_GIRIS_BORDROSU_V2.EKLENME_TARIHI";
        public void getDefault()
        {

            dataGridView1.DataSource = helper.getDataTable("SELECT "+COLS+ " FROM CARI_KARTLAR_V2 INNER JOIN CEK_GIRIS_BORDROSU_V2 ON CARI_KARTLAR_V2.ID=CEK_GIRIS_BORDROSU_V2.CARI ORDER BY CEK_GIRIS_BORDROSU_V2.ID DESC");
        }
        ...
        public void getDetails()
        {
            try
            {
                ...
                dataGridView2.DataSource = helper.getDataTable("SELECT " + col + " FROM CEK_GIRIS_BORDROSU_DETAYLAR WHERE CEK_GIRIS_ID=" + ID + "");
        ...
        public void searchProcess()
        {
            ...
            string[] likeColumns =
            {
                ...
                "CEK_GIRIS_BORDROSU_V2.EVRAK_NUMARASI",
                "CEK_GIRIS_BORDROSU_V2.BELGE_NUMARASI",
                "CEK_GIRIS_BORDROSU_V2.TARIH",
                "CEK_GIRIS_BORDROSU_V2.BELGE_TARIHI",
            };
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT TOP 50 " + COLS + " FROM CARI_KARTLAR_V2 INNER JOIN CEK_GIRIS_BORDROSU_V2 ON CARI_KARTLAR_V2.ID=CEK_GIRIS_BORDROSU_V2.CARI WHERE " + query);
        }
