...
{
    public partial class GIDER_DUZENLE : ComponentFactory.Krypton.Toolkit.KryptonForm
    {

        public int ITEM_ID = 0;
        public GIDER_DUZENLE()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                helper.setSqlCommandForUpdateWithParameters("GIDERLER_V2", col, val, "ID", ITEM_ID.ToString());
        ...
        private void YENI_KASA_EKLE_Load(object sender, EventArgs e)
        {
            ...
            DataTable dt = helper.getDataTable("SELECT*FROM GIDERLER_V2 WHERE ID=" + ITEM_ID + "");
            if (dt.Rows.Count > 0)
            {
        ...
        private void kAYDISİLToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                helper.setSqlCommand("DELETE FROM GIDERLER_V2 WHERE ID=" + ITEM_ID + "");
                this.Close();
            }
        }
    }
