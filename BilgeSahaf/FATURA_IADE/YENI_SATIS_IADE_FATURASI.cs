...
{
    public partial class YENI_SATIS_IADE_FATURASI : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public YENI_SATIS_IADE_FATURASI()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                helper.setSqlCommandForInsertWithParameters("SATIS_IADE_FATURALARI_V2", col, val);
                string lastID = helper.getTableColumnData("SELECT TOP 1 ID FROM SATIS_IADE_FATURALARI_V2 ORDER BY ID DESC", "ID");
