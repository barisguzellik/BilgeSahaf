...
{
    public partial class YENI_STOK_CIKISI : ComponentFactory.Krypton.Toolkit.KryptonForm
    {
        public YENI_STOK_CIKISI()
        {
            InitializeComponent();
        }
        ...
        private void kAYDETToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                helper.setSqlCommandForInsertWithParameters("STOK_CIKISLARI_V2", col, val);
                string lastID = helper.getTableColumnData("SELECT TOP 1 ID FROM STOK_CIKISLARI_V2 ORDER BY ID DESC", "ID");
