...
{
    public partial class STOK_CIKISLARI : Form
    {
        public STOK_CIKISLARI()
        {
            InitializeComponent();
        }
        ...
        {
            dataGridView1.Tag = "StokCikisGrid1";
        ...
        {
            dataGridView1.DataSource = helper.getDataTable("SELECT  " + COLS + " FROM STOK_CIKISLARI_V2 ORDER BY ID DESC");
        ...
        {
            string query = "1=1 ";
            string[] likeColumns = helper.getColumnsNames("STOK_CIKISLARI_V2");
            ...
            dataGridView1.DataSource = helper.getDataTable("SELECT TOP 50 " + COLS + " FROM STOK_CIKISLARI_V2 WHERE " + query);
        }
        ...
        {
            FATURA.YENI_STOK_CIKISI frm = new FATURA.YENI_STOK_CIKISI();
            frm.ShowDialog();
            getDefault();
        }
